...
class Corpus:
    ...
    def get_batch_node2vec_all(self, entity_embeddings, relation_embeddings,current_batch_2hop_indices):
        """
        """
        G=self.graph
        node2vec = Node2vec(G,entity_embeddings, relation_embeddings,current_batch_2hop_indices)
        node_walk,edge_walk = node2vec.node2vecWalk(G,entity_embeddings, relation_embeddings,current_batch_2hop_indices)
